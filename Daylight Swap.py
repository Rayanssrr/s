...
class Daylight(object):
    ...
    def Sucessfully_Claimed(self,session):
        ...
        ctypes.windll.user32.MessageBoxW(0, f"{self.Msg} : {self.Target}  ", f"king {by}", 0x1000);os._exit(0)
...
if __name__ == "__main__":
    ...
    if ip in scan:
        ...
        print("\n");inputc("/",Design.red,f"Press Enter to Started !");sleep(2);ctypes.windll.user32.MessageBoxW(0, f"Are You Ready?", f"king {by}", 0x1000)
